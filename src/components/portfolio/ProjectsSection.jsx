...
import matlex from '../../Images/matlexphilippines.png';
import matlexBuilders from '../../Images/matlexbuilders.png';
...
export default function ProjectsSection({ darkMode }) {
    ...
    return (
        <section
            id="projects"
            className={`py-24 lg:py-32 relative overflow-hidden ${darkMode
                ? 'bg-[#1a1a1a]'
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                >
                    <motion.span
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className={`inline-block px-4 py-2 rounded-full text-sm font-medium mb-6 ${darkMode
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className={`group rounded-2xl overflow-hidden transition-all duration-500 ${darkMode
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden h-48">
                                ...
                                {/* Floating Icon */}
                                <div className={`absolute top-4 right-4 p-3 rounded-xl transition-all duration-300 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 ${darkMode
                            ...
                            <div className="p-6">
                                <h3
                                    className={`text-xl font-semibold mb-3 transition-colors duration-300 ${darkMode
                                ...
                                <p
                                    className={`mb-5 text-sm leading-relaxed ${darkMode ? 'text-gray-400' : 'text-gray-600'
                                        }`}
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tech.map((tech, techIndex) => (
                                        <span
                                            key={techIndex}
                                            className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-colors duration-300 ${darkMode
                                ...
                                <motion.a
                                    ...
                                    className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${darkMode
